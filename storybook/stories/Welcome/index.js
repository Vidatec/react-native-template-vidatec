  ...
  render () {
    return (
      <View style={this.styles.wrapper}>
        ...
        <Text style={this.styles.content}>
          On creating a component with the Filament CLI, it will create a stories.js file alongside your
          component. This will be automatically imported into storybook/index.js so you can immedietely
          start defining your stories in the same folder as your component.
        </Text>
      </View>
    );
  }
